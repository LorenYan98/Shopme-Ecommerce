...
public class CategoryService {
	...
	private List<Category> listHierarchicalCategories(List<Category> rootCategories, String sortDir){
		List<Category> hierarchicalCategories = new LinkedList();
	...
	private void listSubHierarchicalCategories(List<Category> hierarchicalCategories,
		...
		for(Category subCategory : children) {
			...
			hierarchicalCategories.add(Category.copyFull(subCategory, name));	
			listSubHierarchicalCategories(hierarchicalCategories, subCategory, subLevel + 1, sortDir);
		}
	}
	...
	public Category save(Category category) {
		...
		if(parent != null) {
			String allParentIds = parent.getAllParentIDString() == null? "-" : parent.getAllParentIDString();
			allParentIds += String.valueOf(parent.getId()) + "-";
			category.setAllParentIDString(allParentIds);
		}
	...
	public void delete(Integer id) throws CategoryNotFoundException {
		...
		if(children.isEmpty() || children == null) {
			...
			throw new CategoryNotFoundException("The category with ID " + id + " can not be deleted");
		}
	}
